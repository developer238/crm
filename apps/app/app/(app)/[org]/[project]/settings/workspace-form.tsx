...
import { useWorkspaceSlugs } from "@/lib/use-workspace-url";
...
export function WorkspaceForm() {
	...
	const { org: slug, project: projectSlug } = useWorkspaceSlugs();
	...
	const save = useMutation(
		trpc.workspace.update.mutationOptions({
			onSuccess: async (saved) => {
				...
				if (saved.slug !== slug) {
					router.replace(workspaceUrl(saved.slug, projectSlug, "/settings"));
				}
			},
